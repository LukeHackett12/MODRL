...
class DQNAgent(object):
    def __init__(self, stateShape, actionSpace, numPicks, memorySize, numRewards, sync=50, burnin=500, alpha=0.0001, epsilon=1, epsilon_decay=0.9995, epsilon_min=0.01, gamma=0.99):
